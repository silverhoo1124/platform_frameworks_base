...
package com.android.systemui.biantairecent;
...
public class RecentController implements RecentPanelView.OnExitListener,
    ...
    private static final String TAG = "BiantaiRecentController";
    ...
    public RecentController(Context context, int layoutDirection) {
        ...
        mRecentContainer =
                (RelativeLayout) View.inflate(context, R.layout.biantai_recent, null);
